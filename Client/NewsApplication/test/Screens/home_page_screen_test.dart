...
void main() {
  testWidgets('The correct title is displayed on the HomePageScreen', (WidgetTester tester) async {
  ...
  testWidgets('The HeaderComponent widget is present on the HomePageScreen', (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(
        home: new Scaffold(body: HomePageScreen(title: "title"))));
    expect(find.byType(HeaderComponent), findsNWidgets(2));
  });

  testWidgets('The FilterRowsComponent widget is present on the HomePageScreen', (WidgetTester tester) async {
    await tester.pumpWidget(new MaterialApp(
        home: new Scaffold(body: HomePageScreen(title: "title"))));

...
void main() {
  ...
  articleModel.urlToImage =
      "https://cdn.cnn.com/cnnnext/dam/assets/200917212139-biden-interruption-town-hall-0917-super-tease.jpg";
  articleModel.publishedAt = "2020-09-15T17:57:00Z";
  articleModel.content =
      "Keep abreast of significant corporate, financial and political developments around the world.";

  testWidgets('TitleComponent is present on the ArticleRowComponent widget',
    ...
    provideMockedNetworkImages(() async {
      ...
      await tester.pumpWidget(new MaterialApp(
          home:
              new Scaffold(body: ArticleRowComponent(article: articleModel))));
      expect(find.byType(TitleComponent), findsOneWidget);
    });
  });

  testWidgets('CaptionComponent is present on the ArticleRowComponent widget',
      (WidgetTester tester) async {
    provideMockedNetworkImages(() async {
      await tester.pumpWidget(
        MaterialApp(
